...
const RAW_UNITS = [
  {
    id: 'u1',
    greeting: 'Привет! Я Лео. Давай разомнёмся — вспомним числа до ста.',
    host: 'fox',
    title: 'Числа до 100',
    subtitle: 'Разминка',
    color: 'green',
  ...
  {
    id: 'u2',
    greeting: 'Теперь научимся находить спрятанные числа. Это как искать клад!',
    host: 'fox',
    title: 'Плюс и минус',
  ...
  {
    id: 'u3',
    greeting: 'Привет, я Пятныш! Со мной будем писать в столбик. И покажу, зачем нужны скобки.',
    host: 'leopard',
  ...
  {
    id: 'u4',
    greeting: 'А вот теперь самое интересное — умножение! Это когда одинаковых групп много.',
    host: 'leopard',
  ...
  {
    id: 'u5',
    greeting: 'Я Тиг! Готов разогнаться? Учим таблицы дальше.',
    host: 'tiger',
  ...
  {
    id: 'u6',
    greeting: 'Самые трудные таблицы. Но ты уже сильный — точно справишься!',
    host: 'tiger',
    title: 'Самые трудные',
    subtitle: '×9, ×7, ×8',
    color: 'blue',
  ...
  {
    id: 'u7',
    greeting: 'А теперь наоборот! Деление — это умножение задом наперёд.',
    host: 'leopard',
    title: 'Деление',
